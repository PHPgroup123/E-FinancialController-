...
import com.example.e_financialcontroller.Saving;
import com.example.e_financialcontroller.User;
...
import com.example.e_financialcontroller.ui.categories.CategoriesFragment;
...
public class UsrCreateSavingActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usr_create_saving);
        ...
        targetdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(UsrCreateSavingActivity.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth
    ...
    private void caculation() {
        ...
        if (TextUtils.isEmpty(savingname)||TextUtils.isEmpty(savingamount)||TextUtils.isEmpty(Targetdate)){
            Toast.makeText(UsrCreateSavingActivity.this, "Information missing", Toast.LENGTH_SHORT).show();
        }
        else{
            try {
                ...
                if(userincome < savingPerMonth){
                    Toast.makeText(UsrCreateSavingActivity.this, "Insufficient balance!", Toast.LENGTH_SHORT).show();
                }
                else {
                ...
                Toast.makeText(UsrCreateSavingActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void addDatatoFirebase(String savingname, String savingamount, String Targetdate, int month, int year) {
        ...
        Toast.makeText(UsrCreateSavingActivity.this, "Create successfully", Toast.LENGTH_SHORT).show();
        finish();
