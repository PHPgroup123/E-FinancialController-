...
import com.example.e_financialcontroller.ExpensesAdapter;
import com.example.e_financialcontroller.R;
import com.example.e_financialcontroller.Saving;
import com.example.e_financialcontroller.SavingAdapter;
import com.example.e_financialcontroller.UsrCreateExpensesCategoriesActivity;
...
public class ExpensesCategoriesActivity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btnCreateE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            Intent i = new Intent(getActivity(), UsrCreateExpensesCategoriesActivity.class);
            startActivity(i);
            }
        });
